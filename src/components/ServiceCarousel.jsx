    ...
    <section className="relative bg-transparent py-24 overflow-hidden">
      ...
      >
            ...
            return (
              ...
              >
                ...
                <div className="mt-6">
                  ...
                  <div className="mt-6">
                    <Link to={`/services/${s.slug}`} className="inline-flex items-center gap-2 px-5 py-3 rounded-full border border-slate-300 bg-white hover:bg-slate-50 transition shadow max-md:px-4 max-md:py-2">
        ...
        <div className="flex justify-center gap-10 mt-12">
          <button onClick={prev} className="h-14 w-14 rounded-full border border-slate-300 bg-white hover:bg-slate-50 shadow-lg flex items-center justify-center max-md:h-12 max-md:w-12">◀</button>
          <button onClick={next} className="h-14 w-14 rounded-full border border-slate-300 bg-white hover:bg-slate-50 shadow-lg flex items-center justify-center max-md:h-12 max-md:w-12">▶</button>
        </div>
      </motion.div>
    </section>
  )
